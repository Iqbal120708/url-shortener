...
from .views import DetailShortUrlView, ShortUrlView, ClickAnalyticsView
...
urlpatterns = [
    ...
    path("<int:short_url_id>/analytics/", ClickAnalyticsView.as_view(), name="short_url_analytics"),
]
