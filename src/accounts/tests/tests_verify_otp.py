...
class TestVerifyOTP(APITestCase):
    ...
    def test_otp_expired(self):
        ...
        self.assertEqual(res.status_code, 400)
        self.assertEqual(res.data["detail"], "Kode OTP tidak valid atau sudah kadaluwarsa.")
    ...
    def test_error_transaction_db(self, mock_save):
        ...
        self.assertEqual(res.data["detail"], "Terjadi kesalahan saat aktivasi. Silakan coba lagi.")
    ...
    def test_success(self):
        ...
        self.assertEqual(res.data["message"], "Akun berhasil diaktivasi! Silakan login.")
